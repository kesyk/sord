...
namespace CorePract.RmqServer.Messaging.RabbitMQ
{
    public class RabbitMqConnector
    {
        ...
        public void Send( IModel channel,string exchangeName,  string routingKeyName,string message )
        {
        ...
        public void Receive( IModel channel, string queueName, Action<string> callback )
        {
            string message="";
